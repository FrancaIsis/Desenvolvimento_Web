...
document.getElementById('resultado-push').innerHTML =  `
    ...
    <strong>Elementos adicionais:</strong> "Manga", "Abacaxi"<br>       
...
* Parametros: indice inicial(inclusivo), índice final (exclusivo)
*/ 
document.getElementById('botao-slice').addEventListener('click', function(){
   // nao precisa da copia pois o slice ja retorna um novo array
